...
{/* ■ Footer ■ */}
        ...
        <footer className="bg-white/[0.02] backdrop-blur-xl pt-24 pb-12 px-6 relative z-10 border-t border-white/[0.06]">
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center md:items-end justify-between gap-12">
            ...
            <div className="flex flex-col items-center md:items-start text-center md:text-left gap-6">
              ...
              <span className="text-sm text-[var(--color-muted)] mt-2">© 2026 ORCA. All rights reserved.</span>
            </div>

            {/* Right Side */}
            <div className="flex flex-col items-center md:items-end text-center md:text-right gap-3">
              <p className="text-xs font-mono text-[var(--color-muted-light)] max-w-sm">
